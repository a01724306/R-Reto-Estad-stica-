...
```
```{r}
#Libros leídos por año según la generación
ggplot(datos, aes(x = generacion, y = p4, fill = generacion)) +
  geom_boxplot(na.rm = TRUE) +
  coord_cartesian(ylim = c(0, 180)) +
  labs(
    title = "Libros leídos por año por Generación (2019-2024)",
    x = "Generación",
    y = "Libros leídos por año"
  ) +
  theme_minimal() +
  theme(legend.position = "none")
```
