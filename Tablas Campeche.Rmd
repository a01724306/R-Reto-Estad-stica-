...
```{r}
# Crear una tabla para traducir el código de entidad a su nombre
...
# Calcular el promedio de libros leídos p4 por estado
...
```{r}
# Crear tabla de niveles educativos por estado
...
# Añadir columna de total por estado
...
```{r}
# Convertir la tabla de conteos a porcentajes
...
```
```{r}
# Crear data frame manual con datos del Censo
...
# Calcular porcentajes para los datos del Censo
