...
```{r}
# --- Preparación de la variable p31 ---
datos <- datos %>%
  mutate(
...
ggplot(
  ...
  scale_fill_manual(values = c("Sí consulta otras fuentes" = "#2c7fb8", "No consulta otras fuentes" = "#edf8b1")) +
  labs(
    title = "Porcentaje de Lectores que Consultan Otras Fuentes según su Generación (2019-2024)",
    x = "Generación",
    y = "Porcentaje",
    fill = "Comportamiento"
  ) +
